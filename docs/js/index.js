...
"use strict";
/* unused harmony export stringToUtf8Array */
/* harmony export (immutable) */ __webpack_exports__["a"] = byteArrayToString;
/* unused harmony export arrayBufferToString */
/* unused harmony export floatToBase64 */
/* unused harmony export base64ToFloat */
/* unused harmony export base64ToByteArray */
/* unused harmony export arrayBufferToBase64 */
/* unused harmony export base64ToArrayBuffer */
/* unused harmony export byteArrayToBase64 */
/* harmony export (immutable) */ __webpack_exports__["c"] = stringToVariableLengthByteArray;
/* unused harmony export getCommandsBytes */
/* harmony export (immutable) */ __webpack_exports__["b"] = sizeToArrayBuffer;
/* unused harmony export generateCommandBuffer */
/* unused harmony export concatBuffers */
/* unused harmony export concatTypedArrays */
const atob = __webpack_require__(7);
...
function floatToBase64(floatVal) {
...
function stringToVariableLengthByteArray(message) {
...
function getCommandsBytes(commands) {
...
function sizeToArrayBuffer(size) {
    let sizeBuffer;
    if (size >= 65535) {
...
function generateCommandBuffer(commandByte /* Int */, commandBody /* Uint8Array or buffer */) /* returns ArrayBuffer */ {
...
/* unused harmony export ByteEncoder */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__encodingutils__ = __webpack_require__(1);
...
class Mapping {
    ...
    getByteArray(key) {
        ...
        return Array.from(Object(__WEBPACK_IMPORTED_MODULE_0__encodingutils__["c" /* stringToVariableLengthByteArray */])(key));
    }
    getKey(shortKey) {
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Types", function() { return __WEBPACK_IMPORTED_MODULE_0__types__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schema__ = __webpack_require__(5);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Schema", function() { return __WEBPACK_IMPORTED_MODULE_1__schema__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__serialize__ = __webpack_require__(6);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "serialize", function() { return __WEBPACK_IMPORTED_MODULE_2__serialize__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__parse__ = __webpack_require__(13);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "parse", function() { return __WEBPACK_IMPORTED_MODULE_3__parse__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mapping__ = __webpack_require__(2);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Mapping", function() { return __WEBPACK_IMPORTED_MODULE_4__mapping__["a"]; });
...
class Schema {
    constructor(schemaJson) {
        if (Array.isArray(schemaJson)) {
            this.type = __WEBPACK_IMPORTED_MODULE_0__types__["a" /* Types */].array;
            this.elementSchema = new Schema(schemaJson[0]);
        } else if (typeof(schemaJson) === "object") {
            this.type = __WEBPACK_IMPORTED_MODULE_0__types__["a" /* Types */].object;
            this.keySchema = {};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapping__ = __webpack_require__(2);
...
const serializerForType = {
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint8]: serializerForArrayType(__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint8, Uint8Array),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int16]: serializerForArrayType(__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int16, Int16Array),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint16]: serializerForArrayType(__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint16, Uint16Array),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int32]: serializerForArrayType(__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int32, Int32Array),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint32]: serializerForArrayType(__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint32, Uint32Array),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int64]: serializeLong,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint64]: serializeLong,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].double]: serializerForArrayType(__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].double, Float64Array),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].float]: serializerForArrayType(__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].float, Float32Array),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].string]: serializeString,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].bool]: serializeBool,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].array]: serializeArray,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].object]: serializeObject,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].guid]: serializeGuid,
};
/* eslint-enable no-use-before-define */

function serialize(schema, target, mapping = new __WEBPACK_IMPORTED_MODULE_2__mapping__["a" /* Mapping */]()) {
...
function serializeObject(schema, target, mapping) {
    ...
    const sizeBuffer = Object(__WEBPACK_IMPORTED_MODULE_0__encodingutils__["b" /* sizeToArrayBuffer */])(keys.length);
...
function serializeArray(schema, target, mapping) {
    ...
    const sizeBuffer = Object(__WEBPACK_IMPORTED_MODULE_0__encodingutils__["b" /* sizeToArrayBuffer */])(target.length);
    let bytes = Array.from(new Uint8Array(sizeBuffer));
...
function serializeString(schema, target) {
    return Array.from(Object(__WEBPACK_IMPORTED_MODULE_0__encodingutils__["c" /* stringToVariableLengthByteArray */])(target));
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_long__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_long___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_long__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__types__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__encodingutils__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapping__ = __webpack_require__(2);
...
/* eslint-disable no-use-before-define */
const parserForType = {
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint8]: parserForArrayType(Uint8Array, 1),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int16]: parserForArrayType(Int16Array, 2),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint16]: parserForArrayType(Uint16Array, 2),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int32]: parserForArrayType(Int32Array, 4),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint32]: parserForArrayType(Uint32Array, 4),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].int64]: parserForLong(false),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint64]: parserForLong(true),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].double]: parserForArrayType(Float64Array, 8),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].float]: parserForArrayType(Float32Array, 4),
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].string]: parseString,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].bool]: parseBool,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].object]: parseObject,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].array]: parseArray,
    [__WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].guid]: parseGuid,
};
/* eslint-enable no-use-before-define */
...
const stringHeaders = [
    { type: __WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint8, byteLength: 1 },
    { type: __WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint16, byteLength: 2 },
    { type: __WEBPACK_IMPORTED_MODULE_1__types__["a" /* Types */].uint32, byteLength: 4 },
];
...
function parseString(target) {
    ...
    for (const header of stringHeaders) {
        ...
        if (parsedLength.value < maxValue) {
            value = Object(__WEBPACK_IMPORTED_MODULE_2__encodingutils__["a" /* byteArrayToString */])(nextTarget.subarray(0, parsedLength.value));
...
function parserForLong(unsigned) {
    return (target) => {
        ...
        return {
            value: new __WEBPACK_IMPORTED_MODULE_0_long___default.a(array[0], array[1], unsigned),
...
function parse(target, mapping = new __WEBPACK_IMPORTED_MODULE_3__mapping__["a" /* Mapping */]()) {
